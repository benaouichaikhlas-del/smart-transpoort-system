...
// ═══════════════════════════════════════════════════════════════
// 🎨 DESIGN SYSTEM - WITH GLOW & RAY EFFECTS
// ═══════════════════════════════════════════════════════════════
class _DS {
...
class _Card extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: borderColor ?? _DS.border, width: 1.2),
          boxShadow: [
            BoxShadow(
              color: (borderColor ?? _DS.primary).withOpacity(0.18),
              blurRadius: 16,
              spreadRadius: 1,
...
// ═══════════════════════════════════════════════════════════════
// 📱 CONDUCTEUR HOME SCREEN (WITH RADIAL LIGHT RAYS)
// ═══════════════════════════════════════════════════════════════
...
class _ConducteurHomeScreenState extends State<ConducteurHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // 🌌 شعاع ضوئي تدرجي في الأعلى (Top Center Glow Ray)
          Positioned(
            top: -120,
          ...
          // 🌌 شعاع جانبي أسفل الشاشة (Bottom Side Glow Ray)
          Positioned(
            bottom: 40,
            right: -80,
            child: Container(
  ...
  Widget _buildNavItem(IconData icon, String label, int index) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color:
              isSelected ? _DS.primary.withOpacity(0.18) : Colors.transparent,
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color:
                isSelected ? _DS.primary.withOpacity(0.35) : Colors.transparent,
          ),
        ...
        child: Column(
          ...
          children: [
            Icon(icon,
                color: isSelected ? _DS.primary : Colors.white38, size: 24),
            const SizedBox(height: 4),
            Text(
              label,
              style: TextStyle(
                color: isSelected ? _DS.primary : Colors.white38,
                fontSize: 11,
  ...
  String? _extractUserIdFromToken(String token) {
    try {
      ...
      final payload = jsonDecode(
          utf8.decode(base64Url.decode(base64Url.normalize(parts[12]))));
    ...
    await showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setS) => AlertDialog(
          ...
          title: const Row(
            children: [
              Icon(Icons.event_seat, color: _DS.success),
              SizedBox(width: 8),
          ...
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text('Capacité totale: $total places',
              ...
              Row(
                ...
                children: [
                  IconButton(
                    onPressed: () {
                      if (nouvelleValeur > 0) setS(() => nouvelleValeur--);
                    },
                    icon: const Icon(Icons.remove_circle_outline,
                        color: _DS.error, size: 32),
                  ),
                  Container(
                    width: 70,
                  ...
                  IconButton(
                    onPressed: () {
                      if (nouvelleValeur < total) setS(() => nouvelleValeur++);
                    },
                    icon: const Icon(Icons.add_circle_outline,
                        color: _DS.success, size: 32),
                  ),
                ],
              ),
            ],
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                final r = await http.post(
                  ...
                  body: jsonEncode({'places_dispo': nouvelleValeur}),
                );
                if (!mounted) return;
                _showSnack(
                  jsonDecode(r.body)['message'] ?? 'Mis a jour',
                  r.statusCode == 200 ? _DS.success : _DS.error,
                );
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              height: 8,
                              decoration: BoxDecoration(
                                color: _gpsActif ? _DS.success : Colors.white38,
                                shape: BoxShape.circle,
                              ),
                            ),
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(16),
                        border: Border.all(
                            color: _gpsActif ? _DS.success : Colors.white24),
                      ),
                      child: Row(
                        children: [
                          Icon(_gpsActif ? Icons.gps_fixed : Icons.gps_off,
                              color: _gpsActif ? _DS.success : Colors.white70,
                              size: 18),
                          const SizedBox(width: 6),
                          Text(
                            _gpsActif ? 'GPS ON' : 'GPS OFF',
                            style: TextStyle(
                                color: _gpsActif ? _DS.success : Colors.white70,
                                fontSize: 12,
                                fontWeight: FontWeight.bold),
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(color: _DS.success.withOpacity(0.35)),
                    boxShadow: [
                      BoxShadow(
                        color: _DS.success.withOpacity(0.12),
                        blurRadius: 12,
                      )
                    ],
                  ),
                  child: Row(
                    children: [
                      Icon(Icons.tune,
                          color: _DS.success.withOpacity(0.9), size: 22),
                      const SizedBox(width: 12),
                      const Expanded(
                      ...
                      Icon(Icons.arrow_forward_ios,
                          color: _DS.success.withOpacity(0.5), size: 16),
                    ],
                  ),
                ),
              ),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(14),
                          border:
                              Border.all(color: _DS.warning.withOpacity(0.3)),
                        ),
                        child: Column(
                          children: [
                            Row(
            ...
            Row(
              children: [
                const Icon(Icons.people, color: _DS.primary, size: 20),
                const SizedBox(width: 10),
                const Expanded(
                ...
                GestureDetector(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text('Archives',
                          style: TextStyle(
                              color: _DS.warning.withOpacity(0.9),
                              fontSize: 13,
                              fontWeight: FontWeight.w600)),
                    ],
                  ),
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(16),
                              border: Border.all(
                                  color: _DS.primary.withOpacity(0.2)),
                            ),
                            child: Row(
                              children: [
                                Container(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Text(res['passager_email'] ?? 'Passager',
                                          style: const TextStyle(
                                              color: Colors.white,
                                              fontSize: 14,
                                              fontWeight: FontWeight.w600)),
                                ...
                                Container(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                        color:
                                            isToday ? _DS.success : _DS.warning,
                                        fontSize: 10,
                                        fontWeight: FontWeight.bold),
                                  ),
                                ),
                        ...
                        child: Row(
                          children: [
                            Container(
                              ...
                              height: 40,
                              decoration: BoxDecoration(
                                  color: repos ? Colors.white24 : _DS.warning,
...
class _ArchivePageState extends State<_ArchivePage> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Row(
            children: [
              Icon(Icons.archive_outlined, color: _DS.warning, size: 22),
              SizedBox(width: 10),
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return GestureDetector(
                      onTap: () => setState(() => _selectedArchiveDate = date),
                      child: Container(
                        width: 60,
                        margin: const EdgeInsets.symmetric(horizontal: 4),
                        decoration: BoxDecoration(
                          color: isSelected
                              ? _DS.warning.withOpacity(0.2)
                              : const Color(0xFF151B2B),
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(
                            color: isSelected ? _DS.warning : Colors.white12,
                            width: isSelected ? 2 : 1,
                          ),
                          boxShadow: isSelected
                              ? [
                                  BoxShadow(
                                    color: _DS.warning.withOpacity(0.25),
                                    blurRadius: 10,
                                  )
                                ]
                              : null,
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text('${date.day}',
                                style: TextStyle(
                                    color:
                                        isSelected ? _DS.warning : Colors.white,
                                    fontSize: 22,
                                    fontWeight: FontWeight.bold)),
                            const SizedBox(height: 2),
                    ...
                    : _reservationsForDate.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (_, i) {
                              ...
                              if (heureDepart != null)
                                timeStr =
                                    heureDepart.toString().substring(0, 5);
                              return Container(
                                margin: const EdgeInsets.only(bottom: 10),
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  borderRadius: BorderRadius.circular(12),
                                  border: Border.all(
                                      color: _DS.warning.withOpacity(0.2)),
                                ),
                                child: Row(
                                  children: [
                                    Container(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton.icon(
                            onPressed: _enviando
                                ? null
                                : () => _resoudreRetard(_retardEnCours!['id']),
                ...
                _Card(
                  ...
                  child: DropdownButtonHideUnderline(
                    child: DropdownButton<String>(
                      ...
                      style: const TextStyle(color: _DS.textMain, fontSize: 14),
...
class _PannePageState extends State<_PannePage>
  ...
  Future<void> _resoudrePanne(int panneId) async {
    ...
    try {
      final res = await http.post(
        Uri.parse('${ApiConstants.conducteurActions}/panne/$panneId/resoudre'),
        headers: {'Authorization': 'Bearer ${widget.token}'},
      );
      if (!mounted) return;
      if (res.statusCode == 200) {
              ...
              children: [
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          decoration: _inputDecoration(
                              'Type de panne', Icons.warning_amber_rounded),
                          dropdownColor: _DS.surface2,
                          style: const TextStyle(
                          ...
                          items: _typesPanne
                              ...
                              .toList(),
                          onChanged: (v) => setState(() => _typePanne = v),
                        ...
                        TextFormField(
                          ...
                          decoration: _inputDecoration(
                              ...
                              hint: 'Decrivez le probleme rencontre...'),
                        ...
                        _GradientBtn(
                          ...
                          loading: _enviando,
                          colors: const [_DS.error, Color(0xFFDC2626)],
                        ),
                      ],
                    ),
                  ),
                ...
                Row(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          const Icon(Icons.build, color: _DS.textDim, size: 14),
                          const SizedBox(width: 6),
                ...
                if (_chargementPannes)
                  const Center(
                      child: Padding(
                          padding: EdgeInsets.all(32),
                          child: CircularProgressIndicator(color: _DS.error)))
          ...
          if (panne['description'] != null &&
            ...
            Container(
              ...
              child: Text(panne['description'],
                  style: const TextStyle(color: _DS.textMuted, fontSize: 13)),
            ),
          const SizedBox(height: 14),
          Row(
            children: [
              Expanded(
                child: ElevatedButton.icon(
                  onPressed:
                      _enviando ? null : () => _resoudrePanne(panne['id']),
...
class _ProfilPageState extends State<_ProfilPage> {
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                  ...
                  Container(
                    ...
                    child: Row(children: [
                      const Icon(Icons.error_outline,
                          color: _DS.error, size: 18),
                      const SizedBox(width: 8),
                      Expanded(
                        child: Text(errorText!,
                            style: const TextStyle(
                                color: _DS.error, fontSize: 13)),
                      ),
                    ]),
                  ),
                  const SizedBox(height: 12),
                ...
                const SizedBox(height: 10),
                _profilField(
                    adresseCtrl, 'Adresse', Icons.location_on_outlined),
              ],
            ),
          ),
          actions: [
  ...
  // 🔴 دالة حذف الحساب المحسّنة (مع معالجة 200/204 والأخطاء)
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                      color: _DS.primary.withOpacity(0.4),
                                      blurRadius: 20,
                                      spreadRadius: 2,
                                    )
                                  ],
